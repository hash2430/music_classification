...
if __name__ == "__main__":
    ...
    # report_file = Path.method1_path + "report20"
    #
    ...
    # report_file = Path.method2_path + "report20"
    ...
    # report_file = Path.method2_path + "report60"
    #
    ...
    # report_file = Path.method2_path + "report60_mean_var"
    #
    ...
    # IC2_3 =  InstClassf.MfccAll(mfcc_dir, mfcc_dir, report_file)
    # IC2_3.run()
    # counter.finish_measure()
