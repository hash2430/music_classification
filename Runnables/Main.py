...
if __name__ == "__main__":
    ...
    # IC2_3 =  InstClassf.MfccDeltaAdded(mfcc_dir, mean_mfcc_dir, var_mfcc_dir, mean_var_mfcc_dir, report_file)
    # IC2_3.run()
    # counter.finish_measure()



    # 2-4. mfcc performance: 64%
    # mfcc_dir = Path.method2_path + "mfcc60/"
    ...
    # IC2_4 =  InstClassf.MfccAll(mfcc_dir, flat_mfcc_dir, report_file)
    # IC2_4.run()
    # counter.finish_measure()
