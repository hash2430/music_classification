...
if __name__ == "__main__":
    ...
    counter = Counter.Counter(file_name=Path.method1_path + 'time_measure20')
    ...
    counter = Counter.Counter(file_name=Path.method1_path + 'time_measure_knn')
    ...
    #
    # counter = Counter.Counter(file_name=Path.method2_path + 'time_measure60_mean_var_stft')
